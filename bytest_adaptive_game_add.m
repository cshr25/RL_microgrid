function bytest_adaptive_game_add
clear workspace
day=1;
n=24*day;
SoC=zeros(1,n);
...
for t0=1:n
    ...
    [alpha0, alphareal,alphao, kself]=gamesolver_virtual_load(v(t0),t,wa,b0,batterystage,Energy,amin,daygoal,phi,sitenumber,rate,operation,guess);
    alpha(t0)=alphareal;
