function bytest_adaptive_game_add_local_SoC_player_number_compare
day=1;
n=24*day;
SoC=zeros(1,n);
SoC(1)=0.7;
...
adp_int=12;
for limitt=1:20
    rate=1/limitt*ones(1,limitt);
sitaguess=zeros(1,limitt);
